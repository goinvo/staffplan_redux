...
module Types
  module StaffPlan
    class AssignmentType < Types::BaseObject
      ...
      field :assigned_user, Types::StaffPlan::UserType, null: true, description: 'The user assigned to this assignment', method: :user

      def can_be_deleted
        work_weeks.none? { |ww| ww.actual_hours.to_i.positive? }
      end
