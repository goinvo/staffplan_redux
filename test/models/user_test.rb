...
class UserTest < ActiveSupport::TestCase
  describe 'validations' do
    ...
    it 'requires a unique email' do
      ...
      assert_not_predicate other_user, :valid?
    end
  ...
  describe '#owner?' do
    ...
    it 'is false when user is not an owner' do
      ...
      assert_not user.owner?(company: user.current_company)
    end
  end
  ...
  describe '#admin?' do
    ...
    it 'is false when user is not an admin' do
      ...
      assert_not user.admin?(company: user.current_company)
    end
  end
  ...
  describe '#inactive?' do
    ...
    it 'is false when user is active' do
      ...
      assert_not user.inactive?(company: user.current_company)
    end
  end
  ...
  describe '#toggle_status!' do
    ...
    it "toggles the user's status from inactive to active" do
      ...
      Stripe::SyncCustomerSubscriptionJob.stub :perform_later, nil do
        ...
        assert_not user.inactive?(company:)
      end
    end
    ...
    it 'syncs the customer subscription' do
      ...
      job_called = false
      Stripe::SyncCustomerSubscriptionJob.stub :perform_later,
                                               lambda { |arg|
                                                 job_called = true
